...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "shell", inline: "cd /opt/squares && meteor add accounts-ui accounts-google accounts-facebook accounts-password"
  ...
  config.vm.provision "shell", inline: "ln -s /vagrant/public /opt/squares/public"
